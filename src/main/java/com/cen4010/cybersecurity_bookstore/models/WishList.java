...
// This class represents a user's wishlist in the system, storing basic details and maintaining a one-to-many relationship with items the user has added to their wishlist.
